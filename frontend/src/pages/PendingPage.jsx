    ...
    <div className={layoutClasses.container}>
      <div className={layoutClasses.headerWrapper}>
        ...
        <p className="text-sm text-gray-500 mt-1 ml-7">
          {sortedPendingTasks.length} task{sortedPendingTasks.length !== 1 && 's'} Attention needed
        </p>
      </div>
      ...
      >
        <div className="flex items-center justify-center gap-3 text-gray group-hover:text-purple-600 transition-colors">
        ...
        {sortedPendingTasks.length === 0 ? (
          <div className={layoutClasses.emptyState}>
            <div className="max-w-xs mx-auto py-6">
              ...
              <p className="text-sm text-gray-500 mb-4">No pending task</p>
              <button
                onClick={() => setShowModal(true)}
