...
import { ChevronLeft, UserCircle, Save, User, Mail, Lock } from 'lucide-react';
import {
  BACK_BUTTON,
  FULL_BUTTON,
  INPUT_WRAPPER,
...
const Profile = ({ setCurrentUser, onLogout }) => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch(() => toast.error("Can't load profile"));
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <p className="text-gray-500 text-sm">Manage your profile and password</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          ...
          <section className={SECTION_WRAPPER}>
            ...
            <form onSubmit={changePassword} className="space-y-4">
              {passwordFields.map(({ name, type, placeholder }) => (
                <div key={name} className={INPUT_WRAPPER}>
